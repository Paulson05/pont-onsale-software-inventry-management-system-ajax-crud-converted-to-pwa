         ...
         <div class="content">
            <div class="container-fluid">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Daily Purchase Report</a></li>
{{--                            <li class="breadcrumb-item active" aria-current="page">({{\App\Models\invoice::count()}})</li>--}}
                        </ol>
                    </nav>
                <div class="card">
                    <div class="card-header">
                        <h3 class="text-left">Add Purchase <a href="{{route('purchase.index')}}" class="btn btn-success btn-sm float-right "><i class="fa fa-list-ul">add</i></a>
                        </h3>
                    </div>
                                    ...
                                    <div class="modal-body">
                                      ...
                                      <div class="card-body">
                                          <div class="row align-content-center">
                                              <div class="container">
                                                  <form class="form-row" method="GET" action="{{Route('daily.purchase.report.pdf')}}" target="_blank" id="myForm">
